...
* `<134>1 %Z - enlighten - 33 - BOM%P and %P SSL upstream SNI '%S' certificate '%d/%d' extension key usage: '%s', '%s'`
* `<local0.info>1 2020-03-03T02:02:02.000012Z - enlighten - 33 - BOM[192.168.2.10]:46204 and [192.168.2.100]:443 SSL SNI 'www.example.com' certificate '1/3' extension key usage: 'non-critical', 'TLS Web Server Authentication, TLS Web Client Authentication'`

<h4>SSL Upstream Certificate Extension SAN(MSGID: 34)</h4>

* `<134>1 %Z - enlighten - 34 - BOM%P and %P SSL upstream SNI '%S' certificate '%d/%d' extension SAN: '%s', DNS: '%s', IPv4: '%s', IPv6: '%s'`
* `<local0.info>1 2020-03-03T02:02:02.000012Z - enlighten - 34 - BOM[192.168.2.10]:46204 and [192.168.2.100]:443 SSL SNI 'www.example.com' certificate '1/3' extension SAN: 'critical', DNS: 'cloudflare-dns.com, *.cloudflare-dns.com, one.one.one.one', IPv4: '1.1.1.1, 1.0.0.1, 162.159.132.53, 162.159.36.1, 162.159.46.1', IPv6: '2606:4700:4700::1111, 2606:4700:4700::1001, 2606:4700:4700::64, 2606:4700:4700::6400'`
